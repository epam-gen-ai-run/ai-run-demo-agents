...
This agent uses LangGraph with Azure OpenAI to provide currency exchange information through a ReAct agent pattern. The A2A protocol enables standardized interaction with the agent, allowing clients to send requests and receive real-time updates.
...
1. Navigate to the samples directory:
   ...
   ```bash
   cd python/agents/currency_converter
   ```
...
- **Azure OpenAI Integration**: Uses gpt-4o model for intelligent responses
